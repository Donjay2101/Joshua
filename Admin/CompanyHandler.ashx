<%@ WebHandler Language="VB" Class="CompanyHandler" %>
...
Public Class CompanyHandler : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Using conn As New SqlConnection()
            ...
            Using cmd As New SqlCommand()
                cmd.CommandText = "select COMPANY_NAME from COMPANIES where COMPANY_NAME like @SearchText + '%'"
