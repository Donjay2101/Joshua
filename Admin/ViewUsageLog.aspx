<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ViewUsageLog.aspx.vb" Inherits="Admin_ViewUsageLog" %>
            ...
            <td colspan="4" valign="top" bgcolor="#FFFFFF">
             <!-- Begin Content SubTable -->
                <table width="640" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
                    ...
                    <tr>
                        <td><img src="../graphics/1pix.gif" height="20" width="29" alt="" /></td>
                        <td align="left" colspan="5" class="text_blue_bold">View cxPortal Usage Log</td>
                        <td><img src="../graphics/1pix.gif" height="20" width="10" alt="" /></td>        
                    </tr>
                    <tr>
                        <td colspan="7" height="19"><img src="../graphics/1pix.gif" height="19" width="640" alt="" /></td>
                    </tr>
                    <tr>
                        <td width="29"><img src="../graphics/1pix.gif" height="20" width="29" alt="" /></td>
                        <td  colspan="5">
                        ...
                        <td  width="10"><img src="../graphics/1pix.gif" height="185" width="10" alt="" /></td>      
                    </tr>
                    <tr>
                        <td colspan="7" height="19" width="640"><img src="../graphics/1pix.gif" height="19" width="640" alt="" /></td>
                    </tr>
                    <tr>
                        <td><img src="../graphics/1pix.gif" height="20" width="29" alt="" /></td>
                        <td colspan="2">&nbsp;</td>
                        <td><img src="../graphics/1pix.gif" height="20" width="10" alt="" /></td>
                        <td>&nbsp;</td> 
                        <td width="165" align="right" class="text_reg"><asp:LinkButton ID="BTNCancel" runat="server" Width="100%">Back to Project Selection</asp:LinkButton></td>
                        <td><img src="../graphics/1pix.gif" height="20" width="10" alt="" /></td>
                    </tr>
                </table>
