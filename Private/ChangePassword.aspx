 ...
 <div class="row">
     <div class="col-md-10 col-md-offset-2">
          <div class="row form-group">
            ...
            <div class="col-md-8">
                <asp:TextBox ID="txtCurrentPassword" runat="server" class="input-text" TextMode="Password"></asp:TextBox>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <asp:TextBox ID="txtNewPassword" runat="server" class="input-text bodered-input" TextMode="Password"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <asp:TextBox ID="txtConfirmPassword" runat="server" class="input-text bodered-input" TextMode="Password"></asp:TextBox>
